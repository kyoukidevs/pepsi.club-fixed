...
local Window = Library:CreateWindow({
    Title = 'pepsi.club fixed by kyouki',
    Center = true, 
    AutoShow = true,
})
------------------------------------ TABS ------------------------------------
...
local SkyboxesTable = {
    ["Galaxy"] = {
        SkyboxBk = "https://create.roblox.com/store/asset/631671212/Galaxy-Skybox?keyword=galaxy+skybox&pageNumber=1&pagePosition=2",
        SkyboxDn = "https://create.roblox.com/store/asset/631671212/Galaxy-Skybox?keyword=galaxy+skybox&pageNumber=1&pagePosition=2",
        SkyboxFt = "https://create.roblox.com/store/asset/631671212/Galaxy-Skybox?keyword=galaxy+skybox&pageNumber=1&pagePosition=2",
        SkyboxLf = "https://create.roblox.com/store/asset/631671212/Galaxy-Skybox?keyword=galaxy+skybox&pageNumber=1&pagePosition=2",
        SkyboxRt = "https://create.roblox.com/store/asset/631671212/Galaxy-Skybox?keyword=galaxy+skybox&pageNumber=1&pagePosition=2",
        SkyboxUp = "https://create.roblox.com/store/asset/631671212/Galaxy-Skybox?keyword=galaxy+skybox&pageNumber=1&pagePosition=2"
    },
    ["Pink Sky"] = {
